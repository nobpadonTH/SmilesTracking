...
using ThailandpostTracking.HostedServices;
using ThailandpostTracking.Services;
using ThailandpostTracking.Services.Auth;
using ThailandpostTracking.Services.ThailandpostTracking;
using ThailandpostTracking.Startups;
...
namespace ThailandpostTracking
{
    public static class ProjectSetup
    {
        ...
        {
            services.Configure<ThailandpostTrackingSetting>(configuration.GetSection("ThailandpostTrackingSetting"));
            services.AddSingleton<IHttpContextAccessor, HttpContextAccessor>();

            // ใช้สำหรับข้อมูล Login
            services.AddScoped<ILoginDetailServices, LoginDetailServices>();
            services.AddScoped<IThailandpostTrackingServices, ThailandpostTrackingServices>();
        ...
        public static IServiceCollectionQuartzConfigurator ConfigQuartz(this IServiceCollectionQuartzConfigurator q, QuartzSetting quartzSetting)
        {
            ...
            q.AddJobAndTrigger<TrackingInsertJob>(quartzSetting);
            q.AddJobAndTrigger<TrackingUpsertJob>(quartzSetting);
